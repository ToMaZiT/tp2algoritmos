...
Declaración de variables globales y sus tipos:
    ...
    nombres_jugadores: array de strings [MAX_JUGADORES]

    rachas_mm: array de int [MAX_JUGADORES]

    jugadas_secreto_arr: array de int [MAX_JUGADORES]
    victorias_secreto_arr: array de int [MAX_JUGADORES]
    derrotas_secreto_arr: array de int [MAX_JUGADORES]

    victorias_bj: array de int [MAX_JUGADORES]

    creditos_arr: array de int [MAX_JUGADORES]
    aciertos_dados_arr: array de int [MAX_JUGADORES]
"""
...
# devuelve el índice del jugador si existe
...
primerNumero, proximoNumero, racha, indice: int
"""
def menorMayor():
    global rachas_mm
    limpiar_pantalla()
...
"""
nombre: string
objetivo, intentos, apuesta, indice, intentos_usados: int
acerto: boolean
"""
def numeroSecreto():
...
"""
nombre, accion, otra: string
indice, carta_actual, cant_jugador, cant_banca: int
jugar_otra, jugador_perdio, jugador_planto: boolean
palos, valores, mazo, mano_jugador, mano_banca: array
"""
def blackjack():
...
apuesta_cant, dado1, dado2, suma, indice: int
"""
def parImpar():
...
"""
opc_reporte, nombre_buscar: string
i, j, indice: int
nombres_ord, victorias_ord, creditos_ord: array
aux: int
"""
def reporte():
...
def MENU():
    ...
    print(r"| $$    $$| $$  | $$ /$$  \ $$  | $$  | $$\  $$$| $$  | $$          | $$      ")
    print(r"|  $$$$$$/| $$  | $$|  $$$$$$/ /$$$$$$| $$ \  $$|  $$$$$$/       /$$| $$$$$$$$")
    print(r" \______/ |__/  |__/ \______/ |______/|__/  \__/ \______/       |__/|________/")
...
while opc != "F":
    ...
    match opc:
        ...
        case "F":
            limpiar_pantalla()
            print("=" * 45)
            print("  Gracias por jugar, no apueste,")
            print("       juega por diversión")
            print("=" * 45)
